...
| `default_filament_colour` | #9C6B4A |
| `enable_pressure_advance` | 0 |
| `fan_max_speed` | 100 |
...
Hereda de: `0.20mm Standard @Anycubic Kobra 2 Neo 0.4 nozzle`
...
| `print_settings_id` | PETG Default @Kobra 2 Neo |
...
| `print_extruder_id` | 1 |
| `print_extruder_variant` | Direct Drive Standard |
| `print_settings_id` | PLA Default @Kobra 2 Neo |
| `raft_first_layer_density` | 60% |
| `seam_gap` | 10% |
| `seam_position` | back |
| `seam_slope_conditional` | 1 |
...
### Anycubic Kobra 2 Neo Final

Hereda de: `Anycubic Kobra 2 Neo 0.4 nozzle`

| Campo | Valor |
|---|---|
| `deretraction_speed` | 40 |
| `extruder_clearance_height_to_lid` | 10 |
| `extruder_clearance_height_to_rod` | 10 |
| `extruder_clearance_radius` | 10 |
| `input_shaping_type` | ZV |
| `print_host` | 192.168.68.80 |
| `printer_extruder_id` | 1 |
| `printer_extruder_variant` | Direct Drive Standard |
| `printer_settings_id` | Anycubic Kobra 2 Neo Final |
| `printhost_apikey` | FdBsQMbOxP_sXBhV_zMLYV2Zl77JbgLZleW3VBla7JQ |
